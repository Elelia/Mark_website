    ...
    useEffect(() => {
        const fetchDataFilm = async () => {
            try {
                ...
                const categoriesResponse = await axios.get('http://192.168.1.27:5000/seriefilm/film/categories');
                setCategoriesFilm(categoriesResponse.data);

                //const videosResponse = await axios.get('https://mark-api.vercel.app/seriefilm/film');
                const videosResponse = await axios.get('http://192.168.1.27:5000/seriefilm/film');
        ...
        const fetchDataSerie = async () => {
            try {
                ...
                const categoriesResponse = await axios.get('http://192.168.1.27:5000/seriefilm/serie/categories');
                setCategoriesSerie(categoriesResponse.data);

                //const videosResponse = await axios.get('https://mark-api.vercel.app/seriefilm/serie');
                const videosResponse = await axios.get('http://192.168.1.27:5000/seriefilm/serie');
